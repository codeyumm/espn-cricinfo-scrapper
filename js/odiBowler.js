...
async function run(){
    ...
    while(currPage < maxPage){
        ...
        let url = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;orderby=wickets;page=${currPage};spanmin1=01+Jan+1990;spanval1=span;template=results;type=bowling`;
    ...
    //  console.log(allData);
     ...
     const filePath = 'odi_bowling_cricket_data.json';
