...
async function run() {
    ...
    while (currPage <= maxPage) {
        const url = `https://stats.espncricinfo.com/ci/engine/stats/index.html?class=3;page=${currPage};orderby=runs;template=results;type=batting`;
    ...
    const filePath = 't20_batting_cricket_data.json';
